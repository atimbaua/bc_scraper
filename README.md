...
- 🛡️ **Обход защиты Cloudflare:** Использование библиотеки `curl_cffi` с подменой TLS-fingerprint (Chrome 120) и каскадными фоллбэками (ScraperAPI, requests).
...
- ⏱️ **Лимитирование и автоматизация:** Публикация порциями (по умолчанию 5 релизов за запуск) каждый час по расписанию через GitHub Actions.
